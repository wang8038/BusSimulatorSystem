...
public class BusDeploymentStrategyMorningTest {
  ...
  public void testGetNextBus2() {
    ...
    Route testInRoute = TestUtils.createRouteGivenData(stopsIn, distancesIn, probabilitiesIn);
    BusDeploymentStrategyMorning busDeploymentStrategyMorning = new BusDeploymentStrategyMorning();
    Bus testBus1 = busDeploymentStrategyMorning.getNextBus("0", testOutRoute, testInRoute, 1);
    Bus testBus2 = busDeploymentStrategyMorning.getNextBus("1", testOutRoute, testInRoute, 1);
    assertTrue(testBus1 instanceof SmallBus);
    assertTrue(testBus2 instanceof RegularBus);
  }
}
